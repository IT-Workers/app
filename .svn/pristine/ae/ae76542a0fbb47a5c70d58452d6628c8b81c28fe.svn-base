...
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
	...
	public <T> T queryForObject(String sql, Class<T> requiredType) throws DataAccessException {
		return queryForObject(sql, getColumnRowMapper(requiredType));
	}

	@Override
	public <T> List<T> queryForList(String sql, Class<T> elementType) throws DataAccessException {
		return query(sql, getColumnRowMapper(elementType));
	}
	...
	public <T> T queryForObject(String sql, Object[] args, int[] argTypes, Class<T> requiredType)
		...
		return queryForObject(sql, args, argTypes, getColumnRowMapper(requiredType));
	}

	@Override
	public <T> T queryForObject(String sql, Object[] args, Class<T> requiredType) throws DataAccessException {
		return queryForObject(sql, args, getColumnRowMapper(requiredType));
	}
	...
	public <T> List<T> queryForList(String sql, Object[] args, int[] argTypes, Class<T> elementType) throws DataAccessException {
		return query(sql, args, argTypes, getColumnRowMapper(elementType));
	}

	@Override
	public <T> List<T> queryForList(String sql, Object[] args, Class<T> elementType) throws DataAccessException {
		return query(sql, args, getColumnRowMapper(elementType));
	}
	 ...
	 */
	protected <T> RowMapper<T> getColumnRowMapper(Class<T> requiredType) {
		if(requiredType == String.class || requiredType == Integer.class){
